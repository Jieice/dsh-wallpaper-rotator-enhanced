    ...
    function apply(ctx) {
        ...
        const walk = (el) => {
          for (const child of el.children) {
            ...
            if (bigEnough && isSurfaceBg(cs)) {
              ...
              child.setAttribute("data-wp-neutralized", "");
              neutralized.push(child);
            }
            walk(child);
          }
        };
      ...
      function ensureVideoEl() {
        if (videoEl === null && typeof document !== "undefined" && document.body !== null) {
          ...
          videoEl.style.cssText = "position:fixed;inset:0;width:100%;height:100%;object-fit:cover;z-index:-1;pointer-events:none;opacity:0;transition:opacity var(--wp-dur,1200ms) ease;background:transparent;";
